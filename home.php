...
<table border="1" width="900" id="customers">
		<tr>
			...
			<?php
	 $query1="select billno,amount,date,payment,CustomerId,Username,Email,PhoneNumber from bill join customer on bill.cus_id=customer.CustomerId where bill.cus_id='$user_name'";
